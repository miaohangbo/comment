...
public class Blowfish {
	...
	private static final int[] pbox = { 0x243F6A88, 0x85A308D3, 0x13198A2E,
	...
	sbox1 = { 0x4B7A70E9, 0xB5B32944, 0xDB75092E, 0xC4192623, 0xAD6EA6B0,
	...
	sbox2 = { 0xE93D5A68, 0x948140F7, 0xF64C261C, 0x94692934, 0x411520F7,
	...
	sbox3 = { 0x3A39CE37, 0xD3FAF5CF, 0xABC27737, 0x5AC52D1B, 0x5CB0679E,
	...
	private static final int ROUNDS = 16; // 寰幆杩涜鐨勮疆鏁�鍙彉0-16涓斾负鍋舵暟

	private static final int BLOCK_SIZE = 8; // 鍧楃殑闀垮害,鍥哄畾8涓猙yte锛�4浣嶏級

	private static final int GROUP_SIZE = 4; // 缁勭殑闀垮害,4涓猙yte锛�2浣嶏級,鍙彉0-4

	private static final int SBOX_SIZE = 256; // S鐩掔殑闀垮害,鍥哄畾256涓猧nt

	private static final int PBOX_SIZE = 18; // P鐩掔殑闀垮害,鍥哄畾18涓猧nt

	private final int[] S0, S1, S2, S3; // 鍙樻崲鍚庣殑S鐩掞紙琛ㄦ煡璇級

	private final int[] P; // 鍙樻崲鍚庣殑P鐩掞紙瀛愬瘑閽ワ級

	private byte[] key; // 鐢ㄤ簬鍔犲瘑瑙ｅ瘑鐨勫瘑閽�
	...
	private void encryptBlock(byte[] src, int srcOffset, byte[] des,
			int desOffset) {
	...
	private void decryptBlock(byte[] src, int srcOffset, byte[] des,
			int desOffset) {
		int xL = bytesToInt(src, srcOffset);
		int xR = bytesToInt(src, srcOffset + 4);
		// 瑙ｅ瘑绠楁硶
	...
	private void initKey(byte[] key) {
		...
		// 鐢╧ey4涓竴缁勭殑鍘诲紓鎴杙box,鐢ㄥ紓鎴栫殑缁撴灉濉厖P鐩�
		int data;
		int index = 0;
